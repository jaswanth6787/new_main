...
export function CTASection() {
  ...
  return <section className="py-20 wellness-gradient relative overflow-hidden">
      ...
      <div className="text-center mt-12">
        <p className="text-lg text-muted-foreground">
          ...
          <a 
            ...
            className="font-semibold text-wellness-green hover:text-wellness-green/80 underline transition-colors cursor-pointer"
          >
            +91 9347122416
          </a>{" "}
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center w-6 h-6 ml-2 rounded-full bg-[#25D366] hover:bg-[#20BA5A] transition-colors"
            aria-label="WhatsApp"
          ...
          or email{" "}
          <a 
            href="mailto:nhcservice27@gmail.com"
            className="font-semibold text-wellness-green hover:text-wellness-green/80 underline transition-colors cursor-pointer"
          >
            nhcservice27@gmail.com
          </a>
        </p>
      </div>
    </div>
